...
- The first time you see the function `facers(x)`, would you know what it does? __not likely__
- The first time you see the function `facial_recognition(x)`, would you know what it does? _very likely_
